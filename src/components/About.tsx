...
export function AboutTypedTitle() {
  return (
    <ReactTyped strings={['안녕하세요!\n웹 퍼블리셔 임한길 입니다.']} typeSpeed={60} backSpeed={40} backDelay={2000} loop>
    ...
    <section className="about" data-section="about">
      <div className="inner">
        <div className="about-title">
          ...
          <ul>
            <li>에이전시 경험을 바탕으로 깔끔한 UI와 사용자 친화적인 웹 경험을 위해 노력합니다.</li>
            <li>사용자 입장에서 생각하며 기획하며 직접 개발하고 구현하는 작업을 좋아합니다.</li>
          ...
          <div className="links">
            ...
            <CustomLink variant="outline" size="lg" href="/resume/pub_resume.pdf">
              이력서 다운로드
            </CustomLink>
          </div>
        </div>
